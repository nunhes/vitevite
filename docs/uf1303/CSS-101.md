...
3. **Importación e Exportación de Estilos**:
   - Podes importar estilos CSS directamente nos teus ficheiros JavaScript ou TypeScript utilizando unha sintaxe de importación estándar. Isto fai que sexa fácil de xestionar e reutilizar os estilos en toda a túa aplicación.
...
2. **CSS Nano**:
   - CSS Nano é unha ferramenta de minificación de CSS que reduce o tamaño dos ficheiros CSS, eliminando espazos en branco, comentarios e outras partes non necesarias do código.
...
4. **PostCSS Import**:
   - PostCSS Import permite importar ficheiros CSS ou outros tipos de arquivos (como SASS ou LESS) directamente nos teus estilos CSS, facilitando a xestión de estilos compartidos e a organización do código.
...
2. **PurgeCSS**:
   - PurgeCSS é unha ferramenta que analiza o teu código HTML e JavaScript para determinar quais clases CSS son realmente utilizadas na túa aplicación, permitindo eliminar clases non utilizadas e reducir o tamaño dos ficheiros CSS.
...
- **Concatenación**: Combina múltiples ficheiros CSS nun só para reducir o número de peticións ao servidor e diminuír o tempo de carga.
